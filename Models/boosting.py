"""Boosting demonstration using Gradient Boosting."""
...
model=Pipeline([("prep",prep),("boost",GradientBoostingClassifier(n_estimators=80,learning_rate=.1,max_depth=2,random_state=42))])
